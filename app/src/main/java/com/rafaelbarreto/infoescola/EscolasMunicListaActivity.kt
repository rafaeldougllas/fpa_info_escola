...
class EscolasMunicListaActivity : AppCompatActivity() {
    ...
    fun getDatas(): ArrayList<Escola> {
        val schoolObj1 = Escola("Escola 7","Rua ali do lado da esquina 99","https://thumbs.dreamstime.com/b/country-school-building-illustration-33993929.jpg")
        val schoolObj2 = Escola("Escola 8","Rua atras do posto ribeiro da esquina 403","https://thumbs.dreamstime.com/b/country-school-building-illustration-33993929.jpg")
